...
\createbullets{
  ...
  {
    Established and maintained a company-wide developer wiki, fostering knowledge sharing and reducing onboarding time for new engineers.
  },
  {
  ...
  {
    Built an AI-powered loan document processing platform to extract customer data and automate onboarding, increasing user activations by 30\%.
  }
}
