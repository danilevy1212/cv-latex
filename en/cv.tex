...
\addblocktext{Summary}{
  \begin{addmargin}[0cm]{0.66cm}
      \hspace{4ex} Experienced Software Engineer and Tech Lead proficient in Typescript and Python, with an evolving expertise in Golang and Rust, demonstrated through projects on my \href{https://github.com/danilevy1212}{GitHub}. Adept at leading complex projects and scalable system design. Passionate about mentoring, leveraging diverse technologies for innovative solutions, and committed to continuous professional development in emerging languages and frameworks.
  \end{addmargin}
}
...
\createbullets{
  {
    Played a key role in the development and optimization of backend services for Bambu's Robo Advisor, contributing to its core functionality.
  },
  {
  ...
  {
    Collaborated effectively within a diverse, international team, customizing Bambu's Robo Advisor to meet unique requirements of clients worldwide, demonstrating adaptability and cross-cultural communication skills.
  }
}
%
...
\createbullets{
  {
    Spearheaded the design and development of key systems for Rebellion Pay's financial services and internal tools for customer incident resolution.
  },
  {
  ...
  {
    Integrated backend services with various third-party APIs to launch innovative features like cryptocurrency trading and cashback rewards.
  },
  {
    Contributed to the transition from a monolithic REST service to a distributed microservices architecture using NATS, focusing on performance optimization and effective data modeling.
  },
  {
...
\createbullets{
  ...
  {
    Implemented DevOps and adapted SCRUM methodologies to boost team productivity and streamline development processes.
  }
}
%
...
\createbullets{
  ...
  {
    Developed production code, adapting to client requirements and delivering within strict deadlines, honing development skills.
  }
}
