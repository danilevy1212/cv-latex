...
Backend Engineer and Tech Lead specialized in architecting scalable, high-performance systems using TypeScript, Go, and Python. Proven record leading teams through complex migrations from monoliths to microservices, significantly optimizing development workflows, and creating impactful AI-driven automation platforms that directly increase customer engagement and operational efficiency.
  \end{addmargin}
}
...
\addblocktext{Skills}{
  \createskills{
    \createskill{Programming Languages}{
      typescript \cpshalf python \cpshalf golang \cpshalf bash \cpshalf lua
    }
    \createskill{Development Tools}{
      Node.js \cpshalf Jest \cpshalf Poetry \cpshalf Linux \cpshalf NixOS \cpshalf NeoVim
    }
    \createskill{Backend Frameworks}{
      Express.js \cpshalf NestJS \cpshalf Gin \cpshalf Fiber \cpshalf Django \cpshalf Flask
    }
    \createskill{Frontend Skills}{
      React \cpshalf Vue \cpshalf Tailwind \cpshalf Bootstrap \cpshalf Redux \cpshalf Vuex
    }
    \createskill{Databases \& Infrastructure}{
      Docker \cpshalf Kubernetes \cpshalf AWS \cpshalf SNS \cpshalf PostgreSQL \cpshalf MongoDB \cpshalf Redis
    }
    \createskill{Software Design}{
      Design Patterns \cpshalf CI/CD \cpshalf Microservices \cpshalf Serverles 
    }
...
\datedexperience{https://www.autopay.com/}{Autopay}{Tech Lead (Remote, promoted from Backend Engineer in Dec 2022)}{July 2022 - Present}
\createbullets{
  {
  ...
  {
    Automated loan applications with an event-driven system, processing thousands of daily submissions seamlessly.
  },
  {
    Led the migration from a monolithic system to a scalable serverless ecosystem, improving deployment speed and scalability.
  },
  {
...
\datedexperiencenolink{Bambu}{Backend Engineer (Remote)}{January 2022 - June 2022}
\createbullets{
  {
...
\datedexperiencenolink{Rebellion Pay}{Software Engineer (Hybrid)}{November 2020 - November 2021}
\createbullets{
  {
...
\datedexperiencenolink{mr Houston}{Full Stack Developer}{August 2019 - November 2020}
\createbullets{
  {
...
% Footnote (Had to be sacrificed in the name of keeping this in one page)
%\createfootnote
\end{document}
